...
public class pcinfotest implements Parcelable {
    ...
    public pcinfotest(Parcel in) {
        readFromParcel(in);
    }

    public pcinfotest(String pcBangName, int pcBangTel, int postCode, String roadAddress, String detailAddress, int ipFirst, int ipSecond, int ipThird) {
